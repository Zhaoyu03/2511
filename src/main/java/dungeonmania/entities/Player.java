...
public class Player extends NoMoveEntity implements Battleable {
    ...
    public boolean hasZomibes(GameMap map) {
        return map.getEntities(ZombieToast.class) == null;
    }
    ...
    public void onOverlap(GameMap map, Entity entity) {
        if (entity instanceof Enemy) {
            ...
            if (entity instanceof Hydra) {
                if (((Hydra) entity).isIncrease()) {
                    double i = battleStatistics.getAttack() + ((Hydra) entity).newHealth();
                    ((Hydra) entity).getBattleStatistics().setHealth(i);
                }
            }
